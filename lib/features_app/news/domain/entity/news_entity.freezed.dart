...
// **************************************************************************
// FreezedGenerator
// file này sẽ phụ trách copy dạng json ( từ gốc đến instance)
// **************************************************************************
...
class _$_NewsEntity with DiagnosticableTreeMixin implements _NewsEntity {
  const _$_NewsEntity( // No bao sua loi constructor
      {this.title,
      this.description,
      this.url,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$NewsEntityImplCopyWith<_$_NewsEntity> get copyWith =>
      __$$NewsEntityImplCopyWithImpl<_$_NewsEntity>(this, _$identity);
