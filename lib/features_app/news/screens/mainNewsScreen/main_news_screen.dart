...
import 'package:cached_network_image/cached_network_image.dart'; // Dependency
class MainNewsScreen extends StatelessWidget{
                ...
                children: [
                  ...
                  Container(
                   ...
                   GridView.count(
                    ...
                    mainAxisSpacing: 10,
                    children:
                        state.news.map((news) => _newsItem(news)).toList(), //  Tạo thêm wight
                  ),
                ],
              ),
            ),
  ...
  Widget _newsItem(NewsEntity news) {
    ...
    return Container(
      ...
      child: Stack(
        // Kiểm tra các thuộc tính trong entity
        children: [
          if(news.imageUrl == null) // Vãi lúa ( Quả syntax ối rồi ôi)
            const Center(
              child: Text(
                "No image",
                style: TextStyle(
          ...
          // Cần tải hình ảnh về từ url ( Sử dụng đến CacheNetworkImage)
            CachedNetworkImage(
              ...
              const Center(
                child: Text(
                "Loading image encountered errod",
                style: TextStyle(
                  color: Colors.white),
              )),
            ),
